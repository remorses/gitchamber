import type { Registry, PackageSpec, ResolvedPackage } from "../../types.ts";
import { parseNpmSpec, resolveNpmPackage } from "./npm.ts";
import { parsePyPISpec, resolvePyPIPackage } from "./pypi.ts";
import { parseCratesSpec, resolveCrate } from "./crates.ts";
import { isRepoSpec } from "../repo.ts";

export { resolveNpmPackage } from "./npm.ts";
export { resolvePyPIPackage } from "./pypi.ts";
export { resolveCrate } from "./crates.ts";
